...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"blog-client","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"frontend of my blog"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_meta_b618bc34 === 'function') {
    await nuxt_plugin_meta_b618bc34(app.context, inject)
  }

  if (typeof nuxt_plugin_icons_2f0639ee === 'function') {
    await nuxt_plugin_icons_2f0639ee(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_infinitescroll_6b9d679c === 'function') {
    await nuxt_plugin_infinitescroll_6b9d679c(app.context, inject)
  }
