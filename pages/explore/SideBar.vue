<template>
  <div class="explore-sidebar">
    <div class="tags-wrap module">
      ...
      <div ref="loadingTarget" class="module-content">
        <span v-for="tag in tags" @click="viewTag(tag)" :key="tag._id">
    ...
    <div class="contact-me module">
      ...
      <div class="module-content">
        <p>
          <a href="https://github.com/djlxiaoshi/blog/issues" target="_blank"
            >Github</a
          >
        </p>
        <p>
          <a href="https://www.jianshu.com/u/d8657fcf1678" target="_blank"
            >简书</a
          >
        </p>
        <p>
